...
import HomeStackNavigator from '../../PersonNavigator/HomeStack';
import StoreStackNavigator from '../../PersonNavigator/StoreStack';
import MenuStackNavigator from '../../PersonNavigator/MenuStack';
import ProfileStackNavigator from '../../PersonNavigator/ProfileStack';
          ...
          options={{
            tabBarIcon: ({ref}) => (
              <Lottie
                ref={ref}
                loop={false}
                source={require('../../../Assets/NavigationAssets/store 3 (3).json')}
                style={{
                  width: 28,
                  height: 28,
                }}
